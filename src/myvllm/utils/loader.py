                ...
                if layer_match:
                    ...
                    if k_name in hf_weights and v_name in hf_weights:
                        ...
                        try:
                            ...
                            # load qkv weights separately using weight_loader attribute 
                            # instead of direct copy.
            ...
            # 5. All other parameters: load directly (names match HF)
                ...
                try:
                    ...
                    if param.shape != hf_weight.shape:
                        # Handle parallel linear layers with weight_loader instead of direct copy
